...
def GetBackgroundFunction(hB1,hB2,hB3,hB4,hB5):
    ...
    for i in range(hB1.GetNbinsX()+1):
        ...
        if cent<600.0: # For B1, background is below 600cm
...
#injPosY = [-768.14,-768.14,-768.14,-768.14,-768.14]
...
B1File = ROOT.TFile('/hepstore/pmehta/data/RootFilesNov19/Collimator/Completed_full_x_axis/Run_082181_Complete.root')
...
#B1Hist.Fit('gaus','goff','',1000,1500)
#fit_lorentzian = TF1('fit_lorentzian', 'TMath.CauchyDist(x, [0], [1])', 1000, 1500)
...
#B1Line = GetLine(injPosY[0],1,B1Hist.GetMinimum(),B1Hist.GetMaximum())
#B2Line = GetLine(injPosY[1],2,B1Hist.GetMinimum(),B1Hist.GetMaximum())
#B3Line = GetLine(injPosY[2],8,B1Hist.GetMinimum(),B1Hist.GetMaximum())
#B4Line = GetLine(injPosY[3],4,B1Hist.GetMinimum(),B1Hist.GetMaximum())
#B5Line = GetLine(injPosY[4],6,B1Hist.GetMinimum(),B1Hist.GetMaximum())
#B1Line.Draw()
#B2Line.Draw()
#B3Line.Draw()
#B4Line.Draw()
...
#B1Line = GetLine(injPosY[0],4,B1Hist.GetMinimum(),B1Hist.GetMaximum())
B1Hist.Fit('gaus','','',1000,1500)
#B1Hist.Fit('gaus','','',960,1500)
B1Hist.Draw('E1')
B1Line.Draw()
...
#B2Line = GetLine(injPosY[1],4,B2Hist.GetMinimum(),B2Hist.GetMaximum())
...
#B3Line = GetLine(injPosY[2],4,B3Hist.GetMinimum(),B3Hist.GetMaximum())
...
#B4Hist.SetMinimum(0)#check why the above line gives negative values of charge
...
#B4Line = GetLine(injPosY[3],4,B4Hist.GetMinimum(),B4Hist.GetMaximum())
...
##B5Line = GetLine(injPosY[4],4,B5Hist.GetMinimum(),B5Hist.GetMaximum())
