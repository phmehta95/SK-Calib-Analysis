...
B1File = ROOT.TFile("/user/pmehta/Completed_new_MC_zoom_sk5/POS3_435.mc.pos3.1.7_0.8_0.5_10.dat_Completed.root")
...
B1Hist.SetTitle('Overlayed beam spot z profile for B2 collimator for MC and September data')
...
B3File = ROOT.TFile("/user/pmehta/Completed_new_MC_zoom_sk5/POS3_435.mc.pos3.1.7_0.8_0.5_10.dat_Completed.root")
...
B3Hist.SetTitle('Overlayed beam spot y profile for B2 collimator for MC and September data')
